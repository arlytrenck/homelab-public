...
| `monitoring/` | `docker-compose.yaml` | Prometheus, Grafana, node-exporter, cAdvisor, Uptime Kuma, Dozzle, Gotify, Alertmanager (+ a Gotify bridge), autoheal, Loki + Promtail |
